<?php
    function paghiperboleto_config()
    {
        $lsdoc = array();
        $where = array(
        ...
        return array(
            ...
            "vencimento" => array(
                ...
                'Type' => 'dropdown',
                'Options' => array("2"=>"2 Dias","3"=>"3 Dias","4"=>"4 Dias","5"=>"5 Dias","6"=>"6 Dias","7"=>"7 Dias","15"=>"15 Dias"),
    ...
    function paghiperboleto_link($params)
    {
